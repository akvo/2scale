...
class ReplaceRsrCountryActualValuesChangeLogicMaxAggByPeriodThenSum extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        \DB::statement("
            CREATE OR REPLACE VIEW rsr_country_actual_values AS
            SELECT
                data.country,
                data.result_title,
                data.dimension_title,
                SUM(data.period_value) actual_value,
                data.dimension_value_title,
                SUM(data.period_dimension_actual_value) dimension_actual_value
            FROM
            (
                SELECT
                    ...
                    (
                        ...
                        LEFT JOIN
                            ...
                            SELECT
                                *
                            FROM
                                rsr_dimension_values
                            WHERE
                                rsr_dimension_value_target_id IS NOT NULL
                            )
                            rdv
            ...
            FROM
                (SELECT  dm.*, rpdv.value AS period_dimension_actual_value
                    FROM (
                        ...
                        LEFT JOIN (SELECT * FROM rsr_dimension_values WHERE rsr_dimension_value_target_id IS NOT NULL) rdv ON rd.id = rdv.rsr_dimension_id
                ...
                UNION ALL
                    ...
                    FROM (
                        ...
                        GROUP BY
                            ...
                            ds.dimension_value_title,
                            ds.rsr_dimension_value_id,
                            ds.period_value) data
            GROUP BY country, result_title, has_dimension, dimension_title, dimension_value_title
